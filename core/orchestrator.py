...
- ВХОД:           первые 15 мин сессии — полный pipeline (scan → execute)
- СОПРОВОЖДЕНИЕ:  15–60 мин — только мониторинг открытых
- ПОЗДНЯЯ ФАЗА:   60–90 мин — контроль и закрытие
